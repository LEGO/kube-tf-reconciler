...
// Generate CRDs
//go:generate go run sigs.k8s.io/controller-tools/cmd/controller-gen@v0.17.2 rbac:roleName=manager-role crd:maxDescLen=256 object paths="./api/..." output:crd:dir=crds
